...
<body class="fix-menu">
    ...
    <section class="login-block" style="background: #D3D3D3;">
                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="#" method="post" id="login" >
                            <div class="text-center">
                                <img src="<?php echo url('public/logo.png'); ?>" alt="" style="width: 200px;">                         
                            </div>
                                    ...
                                    <div class="row m-t-25">
                                        <div class="col-12">
                                            ...
                                            <div class="forgot-phone text-right f-right">
                                                <a href="<?= url(App\Http\Controllers\admin\BaseController::aUrl('/login')); ?>" class="text-right f-w-600"> or Login here</a>
                                            </div>
                                        </div>
                                    </div>
        ...
        $('#login').submit(function(event) {
            ...
            if (!isSent) {
                if ($('input[name=email]').val() != "") {
                    ...
                    $.ajax({
                        type: "POST",
                        url : "<?= url(App\Http\Controllers\admin\BaseController::aUrl('/forget-check')); ?>",
                        dataType: "JSON",
                ...
                if ($('input[name=otp]').val() == "") {
                    ...
                    $.ajax({
                        type: "POST",
                        url : "<?= url(App\Http\Controllers\admin\BaseController::aUrl('/reset-password')); ?>",
                        dataType: "JSON",
                        ...
                        success: function(out)
                        {
                            if (out._return) {
                                ...
                                setTimeout(function(){
                                    window.location = "<?= url(App\Http\Controllers\admin\BaseController::aUrl('/login')) ?>";
                                },3000);
                            }else{
                                $("#sign-in-button").html('Reset Password');
                                $("#sign-in-button").removeAttr("disabled"); 
    ...
    <script type="text/javascript" src="<?= url('public/admin/') ?>/bower_components/modernizr/js/css-scrollbars.js"></script>
    <!-- i18next.min.js -->
