...
<div class="page-body">
    <form method="post" action="<?= App\Http\Controllers\admin\BaseController::aUrl('/pages/edit') ?>" enctype="multipart/form-data" id="formAddPage">
        {{ csrf_field() }}
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input name="icon" type="text" class="form-control" value="<?= $single->icon ?>" placeholder="ex : fa fa-user">
                        </div>
                    </div> 
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Name <span class="-req">*</span></label>
                            <input name="name" type="text" class="form-control" value="<?= $single->name ?>" placeholder="Name">
                        </div>
                    </div>  
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Url Slug <span class="-req">*</span></label>
                            <input name="slug" type="text" class="form-control" value="<?= $single->slug ?>" placeholder="Url Slug">
                        </div>
                    </div>    
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <textarea name="content" id="editor" class="form-control"><?= $single->content ?></textarea>
                    </div>   
                </div>
            </div>
        ...
        $('#formAddPage').submit(function(e) {
            ...
            if ($('input[name=icon]').val() == "") {
                ...
                var AjaxParam = {
                    ...
                    'data'      : {_token : '<?= csrf_token() ?>',slug : $('input[name=slug]').val(),id:$('input[name=id]').val() },
                    'dataType'  : 'json',
