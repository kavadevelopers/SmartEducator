...
<div class="page-body">
    <form method="post" action="<?= App\Http\Controllers\admin\BaseController::aUrl('/blog/add') ?>" enctype="multipart/form-data" id="formAddPage">
        {{ csrf_field() }}
        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input name="banner" type="file" class="form-control" required>
                        </div>
                    </div> 
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input name="sub" type="text" class="form-control" value="" placeholder="Sub Title" required>
                        </div>
                    </div>  
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Facebook Link <span class="-req">*</span></label>
                            <input name="fb" type="text" class="form-control" value="" placeholder="Facebook Link" required>
                        </div>
                    </div> 
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Instagram Link <span class="-req">*</span></label>
                            <input name="ins" type="text" class="form-control" value="" placeholder="Instagram Link" required>
                        </div>
                    </div> 
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Twiter Link <span class="-req">*</span></label>
                            <input name="twi" type="text" class="form-control" value="" placeholder="Twiter Link" required>
                        </div>
                    </div> 
                    <div class="col-md-12">
